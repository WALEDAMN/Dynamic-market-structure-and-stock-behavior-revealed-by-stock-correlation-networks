...
def community(z1, clusters, save_path, title):
    z1 = z1.detach().numpy()
    #for i in range(1,11):
    ...
    plt.title(title)  # 设置图像标题为时间窗口的标签

    # 调试信息
    print(f"Saving community plot to: {save_path}")

    try:
        plt.savefig(save_path)
        print("Community plot saved successfully.")
